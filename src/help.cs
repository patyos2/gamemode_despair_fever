...
function serverCmdHelp(%this, %cat)
{
	...
	switch$ (%cat)
	{
		...
		case "6" or "rules":
			...
			%text[%count++] = " \c36\c6. \c0You must participate in the class trial!\c6 If someone is referring to you, please at least show that you are there and not AFKing. If you need to be afk, use the /afk command.";
