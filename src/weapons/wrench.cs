datablock ItemData(PipewrenchItem)
{
	category = "DespairWeapon";
	classname = "DespairWeapon";

	shapeFile = $Despair::Path @ "res/shapes/weapons/Pipewrench.dts";
...
function PipewrenchItem::onAdd(%this, %obj)
{
...
datablock ShapeBaseImageData(PipewrenchImage)
{
...
function PipewrenchImage::onMount(%image, %player, %slot)
{
...
function PipewrenchImage::onUnMount(%image, %player, %slot)
{
	cancel(%player.windUpSchedule);
}

function PipewrenchImage::onWindUp(%image, %player)
{
...
function PipewrenchImage::onFire(%image, %player)
{
	cancel(%player.windUpSchedule);
...
function PipewrenchImage::onMeleeHit(%image, %player, %object, %position, %normal)
{
	if (!isObject(%object))
		return;
